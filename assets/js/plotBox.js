...
function createHtmlToolBoxPlot(d){
	var html = "<table>";
	html += "<tr align='left'><td align='right'>" + Number(d[2].toFixed(1)).toLocaleString("pt-BR") + "%</td><td>&emsp;Q3</td></tr>"
	html += "<tr align='left'><td align='right'>" + Number(d[1].toFixed(1)).toLocaleString("pt-BR") + "%</td><td>&emsp;Q2 (mediana)</td></tr>"
	html += "<tr align='left'><td align='right'>" + Number(d[0].toFixed(1)).toLocaleString("pt-BR") + "%</td><td>&emsp;Q1 </td></tr>"
	html += "</table>";
	return html;
}
